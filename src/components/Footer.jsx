...
function Footer() {
  return (
    <div className="bg-[#2d314d] font-sans">
      <div className=" md:h-[20vh]  flex flex-col md:flex-row justify-center md:justify-between items-center md:ml-24 md:mr-24 md:w-[100%-192px]">
        <div className="flex flex-col items-center w-full md:flex-row md:w-[50%] md:gap-28">
          <div className="flex flex-col md:gap-10">
            ...
            <div className="flex flex-row gap-5 md:gap-3 mb-7  md:mb-0 items-center">
              <svg
          ...
          <div className="flex flex-col md:flex-row text-[#f3f4f6] md:gap-28 ">
            <div className="flex flex-col gap-2 items-center">
              <a href="" className="footer-link mb-2 md:mb-0">
                About Us
              </a>
              <a href="" className="footer-link mb-2 md:mb-0">
                Contact
        ...
        <div>
          <div className="flex flex-col justify-center items-center md:items-end mr-">
            <button className="  items-center flex rounded-full bg-gradient-to-r from-customHsl1 to-customHsl2 p-2 px-5 text-[#f3ecec] mx-2 mb-5">
              Request Invite
            </button>
            <p className="text-[#9698a6] mb-2">
